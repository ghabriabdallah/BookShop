      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text("Welcome to TuniBest", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),),
              ...
              Row(
                children: [
                  ...
                  Text("Forgot your password?", style: TextStyle(fontSize: 20, color: Colors.grey[500]),),
                ],
              ),
